...
\leftheader{%
  {
  \vspace{-2.5cm}
  \LARGE\bfseries\sffamily Tinaye Tsinakwadi, M.Sc.}

  \makefield{\faEnvelope[regular]}{\href{mailto:tinayetsina@outlook.com}{\texttt{tinayetsina@outlook.com}}}
  ...
  {\href{https://www.linkedin.com/in/tinayetsina/}{\texttt{tinayesina}}}

  %% Next line
  \makefield{\faGlobe}{\url{https://tinatsina.github.io/}}
...
\begin{minipage}{0.66\textwidth}
	...
	\exhyphenpenalty=10000 % Discourage hyphenation at explicit hyphens
Ich interessiere mich für die Entwicklung von eingebetteten Systemen, Elektronik und Softwaretechnik.
Ich habe Erfahrung mit Python-Programmierung automatisierten Tests und kontinuierlicher Integration für hochwertige eingebettete Geräte.
\end{minipage}
\vspace{0.5cm}
