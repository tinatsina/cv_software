...
\leftheader{%
  {
  \vspace{-2.5cm}
  \LARGE\bfseries\sffamily Tinaye H Tsinakwadi, M.Sc.}
...
\begin{minipage}{0.66\textwidth}
	...
	Passionate about embedded systems development, electronics and software engineering.
	Experienced in Python programming, automated testing, and continuous integration for high-quality embedded devices.
\end{minipage}
\vspace{0.5cm}
